...
const Questions = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axiosClient.get('/questions/getAll', {params: {page, size}});
    ...
    return (
        ...
        <div className="home-container-1">
            ...
            <div className="home-container-2">
              ...
              <Lottie animationData={questionAnim} style={{ width: "100%", height: "100%" }} />
            </div>
                            ...
                            <>
                                <div className="main-bar-header2">
                                    ...
                                    <div className="mainbar-header-buttons">
                                        <Link><button className="btn-mainbar-header">New</button></Link>
                                        <Link><button className="btn-mainbar-header">Active</button></Link>
                                        <Link><button className="btn-mainbar-header">Bountied</button></Link>
                                        <Link><button className="btn-mainbar-header">Unanswered</button></Link>
                                        <Link><button className="btn-mainbar-header">More</button></Link>
                                        <Link><button className="btn-mainbar-header">Filter</button></Link>
                                    </div>
                                </div>
                                    </div>
